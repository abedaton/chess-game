/****************************************************************************
** Meta object code from reading C++ file 'Register.hpp'
**
...
#include "../incl/Register.hpp"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'Register.hpp' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 9, 12), // "enterPressed"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 13) // "escapePressed"

    },
    "Register\0enterPressed\0\0escapePressed"
};
...
void Register::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Register::enterPressed)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (Register::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Register::escapePressed)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Register::enterPressed()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Register::escapePressed()
{
