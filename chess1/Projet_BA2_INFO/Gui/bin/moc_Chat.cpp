...
QT_MOC_LITERAL(1, 5, 14), // "signalLineEdit"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 25) // "on_lineEdit_returnPressed"

    },
    "Chat\0signalLineEdit\0\0on_lineEdit_returnPressed"
};
...
void Chat::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signalLineEdit(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Chat::signalLineEdit)) {
                *result = 0;
                return;
            }
        }
