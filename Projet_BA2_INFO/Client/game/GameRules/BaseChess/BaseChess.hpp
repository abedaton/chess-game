...
#include "../../GameAffichages/Affichage/Affichage.cpp"
...
class BaseChess{
    private:
		...
		Dico* dico;
		int action_cnt;
		AbstractAffichage* affich;

	public:
        BaseChess(Player*,Player*,Player*,Dico*,AbstractAffichage*); //*< Constructor
...
<<<<<<< HEAD:Projet_BA2_INFO/Client/game/Games/BaseChess/BaseChess.hpp
...
>>>>>>> Partie_Serveur:Projet_BA2_INFO/Client/game/GameRules/BaseChess/BaseChess.hpp
...
>>>>>>> Partie_Serveur:Projet_BA2_INFO/Client/game/GameRules/BaseChess/BaseChess.hpp
		...
		void initialise_affichage_partially();
		virtual void initialise_size_affichage_plat_squares();
