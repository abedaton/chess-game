...
Affichage::Affichage(Plateau* plat, Dico* dict,std::string pre,std::string suf ,std::string lang ,Player* play_low, Player* play_high, std::string symb_low, std::string symb_high) : plateau(plat), dico(dict), dico_prefix(pre), dico_suffix(suf), dico_language(lang), low_player(play_low), high_player(play_high),low_player_symbol(symb_low),high_player_symbol(symb_high), taille_case_hor(8), taille_case_ver(3){} //*< Constructor
Affichage::Affichage(Plateau* plat, Dico* dict,std::string pre,std::string suf ,std::string lang ,Player* play_low, Player* play_high, std::string symb_low, std::string symb_high, int t_c_hor, int t_c_ver) : plateau(plat), dico(dict), dico_prefix(pre), dico_suffix(suf), dico_language(lang), low_player(play_low), high_player(play_high),low_player_symbol(symb_low),high_player_symbol(symb_high), taille_case_hor(t_c_hor), taille_case_ver(t_c_ver){} //*< Constructor
