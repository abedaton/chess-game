...
Trinome<std::string,std::string,bool>* TrappistChess::decode_merged_string(std::string merged_string){
...
std::pair<bool,bool> TrappistChess::execute_step(std::string merged_coords){
