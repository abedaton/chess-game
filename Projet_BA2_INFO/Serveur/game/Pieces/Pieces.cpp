...
Pion::Pion(std::string dir) : Chesspiece(), alternative(nullptr), direction(dir) {
	...
	Paire<int,std::string>* a = new Paire<int,std::string>(1,"");
	BitypeVar<Paire<int,std::string>>* alt_third = new BitypeVar<Paire<int,std::string>>(true,*a);
	AdvTuple* alt = new AdvTuple(0,1,"translation",alt_first,alt_second,alt_third);
	
	Paire<int,std::string>* b = new Paire<int,std::string>(1,"");
	BitypeVar<Paire<int,std::string>>* sec_third = new BitypeVar<Paire<int,std::string>>(true,*b);
...
void Pion::make_capt_list(){
	...
	Paire<int,std::string>* a = new Paire<int,std::string>(1,"");
	BitypeVar<Paire<int,std::string>>* one_third = new BitypeVar<Paire<int,std::string>>(true,*a);
	AdvTuple* one = new AdvTuple(1,1,"translation",one_first,one_second,one_third);
	
	Paire<int,std::string>* b = new Paire<int,std::string>(1,"");
	BitypeVar<Paire<int,std::string>>* two_third = new BitypeVar<Paire<int,std::string>>(true,*b);
...
Roi::Roi() : Chesspiece() {
	...
	Paire<int,std::string>* c = new Paire<int,std::string>(1,"");
	BitypeVar<Paire<int,std::string>>* three_third = new BitypeVar<Paire<int,std::string>>(true,*c);
	...
	Paire<int,std::string>* d = new Paire<int,std::string>(1,"");
	BitypeVar<Paire<int,std::string>>* four_third = new BitypeVar<Paire<int,std::string>>(true,*d);
...
Fonctionnaire::Fonctionnaire() : Chesspiece() {
	...
	Paire<int,std::string>* a = new Paire<int,std::string>(0,"prime");
	BitypeVar<Paire<int,std::string>>* one_third = new BitypeVar<Paire<int,std::string>>(true,*a);
	...
	Paire<int,std::string>* b = new Paire<int,std::string>(0,"prime");
	BitypeVar<Paire<int,std::string>>* two_third = new BitypeVar<Paire<int,std::string>>(true,*b);
...
Faucon::Faucon() : Chesspiece() {
	...
	Paire<int,std::string>* e = new Paire<int,std::string>(1,"");
	BitypeVar<Paire<int,std::string>>* five_third = new BitypeVar<Paire<int,std::string>>(true,*e);
	...
	Paire<int,std::string>* f = new Paire<int,std::string>(1,"");
	BitypeVar<Paire<int,std::string>>* six_third = new BitypeVar<Paire<int,std::string>>(true,*f);
	...
	Paire<int,std::string>* g = new Paire<int,std::string>(1,"");
	BitypeVar<Paire<int,std::string>>* seven_third = new BitypeVar<Paire<int,std::string>>(true,*g);
	...
	Paire<int,std::string>* h = new Paire<int,std::string>(1,"");
	BitypeVar<Paire<int,std::string>>* eight_third = new BitypeVar<Paire<int,std::string>>(true,*h);
